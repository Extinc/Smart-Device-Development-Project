...
class HTTP_Auth: NSObject {
     ...
     */
    class func getJSON(url: String, token: String, onComplete:
        ((_: JSON?, _: URLResponse?, _: Error?) -> Void)?)
    {
        requestJSON(url: url,
                    httpMethod: "GET",
    ...
    /**
     ...
     Retrieves the result as a SwiftyJSON object.
     */
    class func postJSON(url: String, token: String, json: JSON, onComplete:
        ((_: JSON?, _: URLResponse?, _: Error?) -> Void)?)
    {
        requestJSON(url: url,
                    httpMethod: "POST",
...
class HTTP_Auth2: NSObject {
    ...
    class func putJSON(url: String, json: JSON, onComplete:
        ((_: JSON?, _: URLResponse?, _: Error?) -> Void)?)
    {
        requestJSON(url: url,
                    httpMethod: "PUT",
